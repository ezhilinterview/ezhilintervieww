      ...
      {!isEditing && (
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center">
            <div className={`flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 rounded-full text-sm sm:text-base ${
              }`}>
              1
            </div>
            ...
            {selectedCategories.length > 0 ? (
              <div className="space-y-3 sm:space-y-4">
                {selectedCategories.map(categoryId => {
                  ...
                  if (!category) return null;
                  return (
                    <div key={categoryId} className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 p-3 sm:p-4 border border-gray-200 rounded-lg">
